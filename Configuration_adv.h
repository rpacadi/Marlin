...
// #define LCD_SET_PROGRESS_MANUALLY //Iskljucio  graphic kontroler
...
#define BABYSTEPPING
  ...
  //#define BABYSTEP_ZPROBE_GFX_OVERLAY // Enable graphical overlay on Z-offset editor ---- ISkljucio grafic display
